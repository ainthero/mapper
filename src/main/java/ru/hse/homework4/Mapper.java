...
public interface Mapper {
     ...
     */
    <T> T readFromString(Class<T> clazz, String input) throws UnsupportedClassException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvalidInputException;
     ...
     */
    <T> T read(Class<T> clazz, InputStream inputStream) throws IOException, UnsupportedClassException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvalidInputException;
     ...
     * @throws IOException в случае ошибки ввода-вывода
     */
    <T> T read(Class<T> clazz, File file) throws IOException, UnsupportedClassException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvalidInputException;
     ...
     */
    String writeToString(Object object) throws IllegalAccessException, UnsupportedClassException;
     ...
     * @throws IOException в случае ошибки ввода-вывода
     */
    void write(Object object, OutputStream outputStream) throws IOException, UnsupportedClassException, IllegalAccessException;
     ...
     * @throws IOException в случае ошибки ввода-вывода
     */
    void write(Object object, File file) throws IOException, UnsupportedClassException, IllegalAccessException;
}
